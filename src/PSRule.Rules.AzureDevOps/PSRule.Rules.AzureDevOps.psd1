#
# Module manifest for module 'PSRule.Rules.AzureDevOps'
#
...
@{
    ...
    # Copyright statement
    Copyright         = '(c) The Cloud Explorers. All rights reserved.'

    # Description of the functionality provided by this module
    Description       = 'Custom fork of PSRule.Rules.AzureDevOps with community-based rule enhancements.'
